...
const MyProfile = () => {
    ...
    return (
        <div className='w-[92%] mx-auto'>
            <div className="flex min-h-screen flex-col w-full justify-center p-6 shadow-md rounded-xl sm:px-12 bg-gray-700">
                <img src={userDB.photo} alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
                <div className="space-y-4 text-center divide-y divide-gray-700">
                    <div className="my-2 space-y-1">
                        <h2 className="text-xl font-semibold sm:text-2xl">{userDB.name}</h2>
                        <p className="px-5 text-xs sm:text-base dark:text-gray-400">{userDB.email}</p>
                    </div>
