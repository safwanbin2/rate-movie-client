        ...
        <footer className="bg-base dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl">
                <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            <li className="mb-4">
                                <a href="/" className="text-gray-300  hover:underline">About</a>
                            </li>
                            <li className="mb-4">
                                <a href="/" className="text-gray-300 hover:underline">Careers</a>
                            </li>
                            <li className="mb-4">
                                <a href="/" className="text-gray-300 hover:underline">Brand Center</a>
                            </li>
                            <li className="mb-4">
                                <a href="/" className="text-gray-300 hover:underline">Blog</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                ...
                <div className="px-4 py-6 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://text-gray-300 flowbite.com/">Flowbite™</a>. All Rights Reserved.
                    </span>
